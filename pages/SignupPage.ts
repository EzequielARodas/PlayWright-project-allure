...
export default class SignupPage{
    ...
    async signupUsingAPI(request:APIRequestContext,user:User,context:BrowserContext){
        ...
        user.setAccesToken(access_token);
